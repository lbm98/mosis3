from CBD.converters.latexify.functions import BLOCK_MAP as _BLOCK_MAP
...
if __name__ == '__main__':
	...
	from CBD.lib.std import AdderBlock, ConstantBlock, InverterBlock, ProductBlock, DelayBlock
